...
db/nhdarea_%: data/NHDPLUS_H_%_HU4_GDB.zip db/postgis
	...
	ogr2ogr \
		...
		-f PGDump \
		-skipfailures \
		-where "fcode NOT IN (31800, 33601, 33603, 34300, 34305, 34306, 36400, 40300, 40307, 40308, 40309, 44500, 46003, 46007, 46100, 48400, 48500, 56800)" \
		/vsistdout/ \
		$< \
...
db/wbdhu2: data/National_WBD_GDB.zip db/postgis
	$(eval relation := $(notdir $@))
	@psql -c "\d $(relation)" > /dev/null 2>&1 || \
	ogr2ogr \
		--config PG_USE_COPY YES \
...
db/wbdhu4: data/National_WBD_GDB.zip db/postgis
	$(eval relation := $(notdir $@))
	@psql -c "\d $(relation)" > /dev/null 2>&1 || \
	ogr2ogr \
		--config PG_USE_COPY YES \
...
db/wbdhu8: data/National_WBD_GDB.zip db/postgis
	$(eval relation := $(notdir $@))
	@psql -c "\d $(relation)" > /dev/null 2>&1 || \
	ogr2ogr \
		--config PG_USE_COPY YES \
...
data/NHDPLUS_H_19020401_HU4_GDB.zip:
	$(call download,https://prd-tnm.s3.amazonaws.com/StagedProducts/Hydrography/NHDPlusHR/Beta/GDB/NHDPLUS_H_19020401_HU8_GDB.zip)

.PRECIOUS: data/NHDPLUS_H_19020402_HU4_GDB.zip

# TODO filename is wrong
data/NHDPLUS_H_19020402_HU4_GDB.zip:
	$(call download,https://prd-tnm.s3.amazonaws.com/StagedProducts/Hydrography/NHDPlusHR/Beta/GDB/NHDPLUS_H_19020402_HU8_GDB.zip)

.PRECIOUS: data/NHDPLUS_H_19020501_HU4_GDB.zip

# TODO filename is wrong
data/NHDPLUS_H_19020501_HU4_GDB.zip:
	$(call download,https://prd-tnm.s3.amazonaws.com/StagedProducts/Hydrography/NHDPlusHR/Beta/GDB/NHDPLUS_H_19020501_HU8_GDB.zip)

.PRECIOUS: data/NHDPLUS_H_19020502_HU4_GDB.zip

# TODO filename is wrong
data/NHDPLUS_H_19020502_HU4_GDB.zip:
	$(call download,https://prd-tnm.s3.amazonaws.com/StagedProducts/Hydrography/NHDPlusHR/Beta/GDB/NHDPLUS_H_19020502_HU8_GDB.zip)

.PRECIOUS: data/NHDPLUS_H_19020503_HU4_GDB.zip

# TODO filename is wrong
data/NHDPLUS_H_19020503_HU4_GDB.zip:
	$(call download,https://prd-tnm.s3.amazonaws.com/StagedProducts/Hydrography/NHDPlusHR/Beta/GDB/NHDPLUS_H_19020503_HU8_GDB.zip)

.PRECIOUS: data/NHDPLUS_H_19020504_HU4_GDB.zip

# TODO filename is wrong
data/NHDPLUS_H_19020504_HU4_GDB.zip:
	$(call download,https://prd-tnm.s3.amazonaws.com/StagedProducts/Hydrography/NHDPlusHR/Beta/GDB/NHDPLUS_H_19020504_HU8_GDB.zip)

.PRECIOUS: data/NHDPLUS_H_19020505_HU4_GDB.zip

# TODO filename is wrong
data/NHDPLUS_H_19020505_HU4_GDB.zip:
	$(call download,https://prd-tnm.s3.amazonaws.com/StagedProducts/Hydrography/NHDPlusHR/Beta/GDB/NHDPLUS_H_19020505_HU8_GDB.zip)

.PRECIOUS: data/NHDPLUS_H_%_HU4_GDB.zip

data/NHDPLUS_H_%_HU4_GDB.zip:
	$(call download,https://prd-tnm.s3.amazonaws.com/StagedProducts/Hydrography/NHDPlusHR/Beta/GDB/$(notdir $@))
